...
function Timeline() {
  return (
    <section className="w-full">
	  ...
	  <ul className="flex flex-col items-center justify-center mt-10"> {/* Added space-y-8 for 2rem gap */}
        {/* Prelims Round */}
        <li className="border-l-2 border-blue-600 max-w-3xl"> {/* Increased width by 15% */}
          <div className="md:flex flex-start gap-6">
            ...
            <div className="flex flex-col items-start bg-white p-6 shadow-[4px_4px_25px_rgba(0,0,0,0.25)] rounded-3xl mb-8 relative w-full">
              ...
              <p className="text-gray-600">
                ...
                (max 90 seconds). Teams can also submit their prototype if any.
                The shortlisted will be invited to the finals.
              </p>
        ...
        {/* Finals Round */}
        <li className="border-l-2 border-blue-600 w-{600px} max-w-3xl"> {/* Increased width by 15% */}
          <div className="md:flex flex-start gap-6">
            <div className="bg-white border-4 border-blue-600 w-6 h-6 flex items-center justify-center rounded-full -ml-3"/>
            <div className="flex flex-col items-start bg-white p-6 shadow-[4px_4px_25px_rgba(0,0,0,0.25)] rounded-3xl relative w-full">
              ...
              <div className="absolute top-0 right-0 bg-orange-200 text-orange-600 px-4 py-2 rounded-tr-3xl rounded-bl-3xl text-sm">
                <strong>On Unstop</strong>
              </div>
            </div>
          </div>
